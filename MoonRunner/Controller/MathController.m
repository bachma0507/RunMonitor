...
+ (NSString *)stringifySecondCountDouble:(float)seconds usingLongFormat:(BOOL)longFormat {
    ...
    float hours = remainingSeconds / 3600;
    ...
    if (longFormat) {
        if (hours > 0) {
            return [NSString stringWithFormat:@"%fhr %fmin %fsec", hours, minutes, remainingSeconds];
            
        } else if (minutes > 0) {
            return [NSString stringWithFormat:@"%fmin %fsec", minutes, remainingSeconds];
            
        } else {
            return [NSString stringWithFormat:@"%fsec", remainingSeconds];
        }
    } else {
        if (hours > 0) {
            return [NSString stringWithFormat:@"%02f:%02f:%02f", hours, minutes, remainingSeconds];
            
        } else if (minutes > 0) {
            return [NSString stringWithFormat:@"%02f:%02f", minutes, remainingSeconds];
            
        } else {
            return [NSString stringWithFormat:@"00:%02f", remainingSeconds];
        }
    }
}
